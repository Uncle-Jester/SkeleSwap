...
""" class OBJECT_OT_select_source_armature(bpy.types.Operator):
    bl_idname = "object.select_source_armature"
    bl_label = "Select Source Armature"
    
    def execute(self, context):
        print('selecting source armature')
...
class OBJECT_OT_select_target_armature(bpy.types.Operator):
    bl_idname = "object.select_target_armature"
...
class OBJECT_OT_link_blendshapes_animation(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if is_mb_to_epic:
            filepath = os.path.join(imports_dir, "ARKIT_Blendshape_Animations_For_MB_Lab_FaceRig.blend") # TBD?: Make it possible to link outside blendifles containing the blendshapes animations, making this feature available for the custom templates outside of MBLab
...
class OBJECT_OT_create_lods(bpy.types.Operator):
    ...
    # TBD: Add logic, that transfers the facial shapkeys to the LODS (preferable only to the detailed LODs)
...
def register():
    ...
    #bpy.utils.register_class(OBJECT_OT_select_source_armature)
    #bpy.utils.register_class(OBJECT_OT_select_target_armature)
...
def unregister():
    ...
    #bpy.utils.unregister_class(OBJECT_OT_select_source_armature)
    #bpy.utils.unregister_class(OBJECT_OT_select_target_armature)
